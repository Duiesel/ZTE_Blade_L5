...
const int g_TpVirtualKey[] = {TOUCH_KEY_BACK, TOUCH_KEY_MENU, TOUCH_KEY_MENU, TOUCH_KEY_SEARCH};
...
//                      "msg2xxx", NULL); 
	...
	{
		DBG("Creat ctp_key_define_struct device file error!!\n");
	}
