...
//AE target
#define  SP2519_P1_0xeb  0x7c//78//80//78
#define  SP2519_P1_0xec  0x7c//6e//74//78
//HEQ
#define  SP2519_P1_0x10  0x80 ////ku_outdoor  equal 0xdd of SP2519 //0x80
#define  SP2519_P1_0x11  0x80 //ku indoor  //0x80
#define  SP2519_P1_0x12  0x88 //ku dummy //0x80
#define  SP2519_P1_0x13  0x88 //ku low  //0x80

#define  SP2519_P1_0x14  0x90 //kl outdoor //0xa0
#define  SP2519_P1_0x15  0x90 //kl indoor  //0xa0
#define  SP2519_P1_0x16  0x88// kl dummy //0xa0
#define  SP2519_P1_0x17  0x80 //kl lowlight //0xa0
...
SP2519_write_cmos_sensor(0x2e,0xc5);
...
SP2519_write_cmos_sensor(0xa2,0x16);
SP2519_write_cmos_sensor(0xa3,0x22);
SP2519_write_cmos_sensor(0xa4,0x1e);
SP2519_write_cmos_sensor(0xa5,0x1a);
SP2519_write_cmos_sensor(0xa6,0x12);
SP2519_write_cmos_sensor(0xa7,0x1c);
SP2519_write_cmos_sensor(0xa8,0x1b);
SP2519_write_cmos_sensor(0xa9,0x19);
SP2519_write_cmos_sensor(0xaa,0x12);
SP2519_write_cmos_sensor(0xab,0x1c);
SP2519_write_cmos_sensor(0xac,0x16);
SP2519_write_cmos_sensor(0xad,0x01);
SP2519_write_cmos_sensor(0xae,0x03);
SP2519_write_cmos_sensor(0xaf,0x01);
SP2519_write_cmos_sensor(0xb0,0x03);
SP2519_write_cmos_sensor(0xb1,0x03);
SP2519_write_cmos_sensor(0xb2,0x03);
SP2519_write_cmos_sensor(0xb3,0x03);
SP2519_write_cmos_sensor(0xb4,0x03);
SP2519_write_cmos_sensor(0xb5,0x05);
SP2519_write_cmos_sensor(0xb6,0x03);
SP2519_write_cmos_sensor(0xb7,0x05);
SP2519_write_cmos_sensor(0xb8,0x05);
SP2519_write_cmos_sensor(0xfd,0x02);
...
SP2519_write_cmos_sensor(0x2c,0x20);
	...
	//d65 10                                                                                 
SP2519_write_cmos_sensor(0x66,0x1f);
SP2519_write_cmos_sensor(0x67,0x42);
SP2519_write_cmos_sensor(0x68,0xce);
SP2519_write_cmos_sensor(0x69,0xee);
SP2519_write_cmos_sensor(0x6a,0xa5);
SP2519_write_cmos_sensor(0x7c,0x1e);
SP2519_write_cmos_sensor(0x7d,0x43);
SP2519_write_cmos_sensor(0x7e,0xee);
SP2519_write_cmos_sensor(0x7f,0x14);
SP2519_write_cmos_sensor(0x80,0xa6);
SP2519_write_cmos_sensor(0x70,0x0a);
SP2519_write_cmos_sensor(0x71,0x26);
SP2519_write_cmos_sensor(0x72,0x14);
SP2519_write_cmos_sensor(0x73,0x39);
SP2519_write_cmos_sensor(0x74,0xaa);
SP2519_write_cmos_sensor(0x6b,0xf0);
SP2519_write_cmos_sensor(0x6c,0x0b);
SP2519_write_cmos_sensor(0x6d,0x1d);
SP2519_write_cmos_sensor(0x6e,0x43);
SP2519_write_cmos_sensor(0x6f,0x6a);
SP2519_write_cmos_sensor(0x61,0xcc);
SP2519_write_cmos_sensor(0x62,0xf0);
SP2519_write_cmos_sensor(0x63,0x36);
...
SP2519_write_cmos_sensor(0x65,0x5a);
	...
	SP2519_write_cmos_sensor(0xe9,0x40);
	SP2519_write_cmos_sensor(0xed,0x48);
	SP2519_write_cmos_sensor(0xea,0x30);
	SP2519_write_cmos_sensor(0xee,0x38);
	SP2519_write_cmos_sensor(0xeb,0x28);
	SP2519_write_cmos_sensor(0xef,0x20);
	...
	SP2519_write_cmos_sensor(0x83,0x22);
	...
	SP2519_write_cmos_sensor(0xfd,0x01);
	SP2519_write_cmos_sensor(0x8b,0x00);
	SP2519_write_cmos_sensor(0x8c,0x0a);
	SP2519_write_cmos_sensor(0x8d,0x15);
	SP2519_write_cmos_sensor(0x8e,0x22);
	SP2519_write_cmos_sensor(0x8f,0x2d);
	SP2519_write_cmos_sensor(0x90,0x45);
	SP2519_write_cmos_sensor(0x91,0x58);
	SP2519_write_cmos_sensor(0x92,0x68);
	SP2519_write_cmos_sensor(0x93,0x78);
	SP2519_write_cmos_sensor(0x94,0x8d);
	SP2519_write_cmos_sensor(0x95,0x9e);
	SP2519_write_cmos_sensor(0x96,0xab);
	SP2519_write_cmos_sensor(0x97,0xb7);
	SP2519_write_cmos_sensor(0x98,0xc0);
	SP2519_write_cmos_sensor(0x99,0xca);
	SP2519_write_cmos_sensor(0x9a,0xd2);
	SP2519_write_cmos_sensor(0x9b,0xdb);
	SP2519_write_cmos_sensor(0x9c,0xe4);
	SP2519_write_cmos_sensor(0x9d,0xea);
	SP2519_write_cmos_sensor(0x9e,0xf2);
	SP2519_write_cmos_sensor(0x9f,0xfa);
	...
	SP2519_write_cmos_sensor(0xdd,0x2d);
	SP2519_write_cmos_sensor(0xde,0x24);
	...
	//sat u                                                                                            
	SP2519_write_cmos_sensor(0xfd,0x01);
SP2519_write_cmos_sensor(0xd3,0x98);//94 sjl
SP2519_write_cmos_sensor(0xd4,0x78);//80  sjl
SP2519_write_cmos_sensor(0xd5,0x74);
SP2519_write_cmos_sensor(0xd6,0x74);
	//sat v     7                                                                                      
SP2519_write_cmos_sensor(0xd7,0x98);//94  sjl
SP2519_write_cmos_sensor(0xd8,0x78);//80   sjl
SP2519_write_cmos_sensor(0xd9,0x74);
SP2519_write_cmos_sensor(0xda,0x74);
	...
	SP2519_write_cmos_sensor(0xc3,0x88);
	...
	SP2519_write_cmos_sensor(0x90,0x20);
	SP2519_write_cmos_sensor(0x91,0x20);
	SP2519_write_cmos_sensor(0x92,0x20);
	SP2519_write_cmos_sensor(0x93,0x20);
...
UINT32 SP2519Open(void)
{
	...
	{
		SP2519_write_cmos_sensor(0xfd,0x00);
		sensor_id = ((SP2519_read_cmos_sensor(0x02)<<8) | SP2519_read_cmos_sensor(0xa0));
...
UINT32 SP2519_get_sensor_id(UINT32 *sensorID) 
{
		...
		{
			   SP2519_write_cmos_sensor(0xfd, 0x00); 
			*sensorID = ((SP2519_read_cmos_sensor(0x02)<<8) | SP2519_read_cmos_sensor(0xa0));
...
void SP2519_MIPI_GetExifInfo(UINT32 exifAddr)
{
    SENSOR_EXIF_INFO_STRUCT* pExifInfo = (SENSOR_EXIF_INFO_STRUCT*)exifAddr;
    pExifInfo->FNumber = 28;
    pExifInfo->AEISOSpeed = isoSpeed;
    pExifInfo->AWBMode = awbMode;
    pExifInfo->CapExposureTime= SP2519_Read_Shutter();
    pExifInfo->FlashLightTimeus = 0;
    pExifInfo->RealISOValue = isoSpeed;
    //printk("CapExposureTime=%x\n",SP2519_Read_Shutter());
}
        ...
        UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    case SENSOR_FEATURE_GET_EXIF_INFO:
             SP2519_MIPI_GetExifInfo((UINT32) (*pFeatureData32));
             break;	
    default:
        break;
	}
