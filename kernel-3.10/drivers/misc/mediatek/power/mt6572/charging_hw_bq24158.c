...
static void hw_bc11_dump_register(void)
{
 ...
 static kal_uint32 charging_hw_init(void *data)
 {
	...
	bq24158_config_interface_liao(0x01,0x78);	//TE=1, CE=0, HZ_MODE=0, OPA_MODE=0
	bq24158_config_interface_liao(0x05,0x03);

	bq24158_config_interface_liao(0x04,0x5A); //146mA
	if ( !charging_init_flag ) {
		bq24158_config_interface_liao(0x04,0x4A); //146mA
