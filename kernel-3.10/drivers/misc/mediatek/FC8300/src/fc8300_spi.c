...
static int fc8300_spi_probe(struct spi_device *spi)
{
	...
	print_log(0, "fc8300_spi_probe state 2\n");
	if (ret < 0)
		return ret;

	fc8300_spi = spi;
	print_log(0, "fc8300_spi_probe state 3\n");
	return ret;
}
...
static struct of_device_id fc8300_match_table[] = {
	{
...
s32 fc8300_spi_init(HANDLE handle, u16 param1, u16 param2)
{
	...
	print_log(0, "fc8300_spi_init : spi_register_board_info \n");
	res = spi_register_board_info(fc8300_spi_devs, ARRAY_SIZE(fc8300_spi_devs));
